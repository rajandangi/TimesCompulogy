...
if ( ! function_exists( 'university_hub_footer_copyright' ) ) :
	...
	function university_hub_footer_copyright() {
		...
		// Powered by content.
		$powered_by_text = sprintf( __( '
			<div class="site-info">
				Proudly Powered By 
				<a target="_blank" rel="designer" href="https://sathisoft.com/">SathiSoft Pvt.Ltd</a>			    	
			</div> %s', 'university-hub' ), 
			'<a target="_blank" rel="designer" href="https://sathisoft.com/">' . __( ' ', 'university-hub' ) . '</a>' );
